...
//552a1692fd98c51dbe00102f appk
#define KShareSDKAppKey @"6a3105207d21"
#define kSinaWeiboAppKey @"2946215424"
#define kSinaWeiBoAppSecret @"5db6a206f67efb3e3ef4cea6534af677"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    DDMenuController * rootController = [[DDMenuController alloc] initWithRootViewController:navc];
...
- (void)registerUMSDK{
    ...
    [UMSocialData setAppKey:kUmengSDKAppKey];
}
